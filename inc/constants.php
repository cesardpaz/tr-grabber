...
$config_grabber['prefix_year'] = isset( $config_grabber['prefix_year'] ) ? $config_grabber['prefix_year'] : __('release', 'tr-grabber');
$config_grabber['post_status'] = isset( $config_grabber['post_status'] ) ? $config_grabber['post_status'] : 'publish';
$config_grabber['post_language'] = isset( $config_grabber['post_language'] ) ? $config_grabber['post_language'] : 'none';
$config_grabber['post_quality'] = isset( $config_grabber['post_quality'] ) ? $config_grabber['post_quality'] : 'none';
...
define( 'TR_GRABBER_POST_LANGUAGE', $config_grabber['post_language'] );
define( 'TR_GRABBER_POST_QUALITY', $config_grabber['post_quality'] );
...
define( 'TR_GRABBER_PREFIX_YEAR', $config_grabber['prefix_year'] );
...
define( 'TR_GRABBER_FIELD_RATING', 'rating' );
